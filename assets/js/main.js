  ...
  document.querySelectorAll('.whatsapp-form').forEach((form) => {
    form.addEventListener('submit', (event) => {
      ...
      const lines = [
        'Hello Rachid,',
        '',
        'I would like to discuss a bioinformatics project.',
        '',
        `Name: ${name || 'Not provided'}`,
        `Company/Lab: ${company || 'Not provided'}`,
      ...
      const baseUrl = whatsappNumber ? `https://wa.me/${whatsappNumber}?text=` : 'https://wa.me/?text=';
      window.open(`${baseUrl}${encodeURIComponent(lines.join('\n'))}`, '_blank', 'noopener');
    });
  });
